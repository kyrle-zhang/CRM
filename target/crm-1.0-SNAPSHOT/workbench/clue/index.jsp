...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#creatBtn").click(function (){
			...
			//2.从ServletContext中获取数据字典为相应的下拉框铺值
			//通过EL表达式和JSTL forEach 标签完成
			//3.打开模态窗口
	...
	function pageList(pageNo,pageSize){
		...
		$.ajax({
			...
			type : "get",
			success : function (data){
				//data: {"total":总记录条数,"dataList":[{线索1},{线索2}...]}
				let html = "";
